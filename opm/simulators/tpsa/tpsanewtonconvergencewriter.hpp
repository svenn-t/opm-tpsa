...
/*
  ...
  copyright holders.
*/
#ifndef TPSA_NEWTON_CONVERGENCE_WRITER_HPP
#define TPSA_NEWTON_CONVERGENCE_WRITER_HPP
...
public:
    ...
    * \brief Constructor
    */
    explicit TpsaNewtonConvergenceWriter()
    { }

    /*!
    * \brief Called by the Newton method before the actual algorithm is started for any given timestep.
    */
    void beginTimeStep()
    { }

    /*!
    * \brief Called by the Newton method before an iteration of the Newton algorithm is started.
    */
    void beginIteration()
    { }
    ...
    */
    ...
    /*!
    * \brief Called by the Newton method after an iteration of the Newton algorithm has been completed.
    */
    void endIteration()
    { }
